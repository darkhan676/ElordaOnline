...
urlpatterns = [
    ...
    path('fetch-favorite-status/<int:student_id>/<int:course_id>',views.fetch_favorite_course),
    ...
    path('student/fetch-all-notifications/<int:student_id>',views.NotificationsList.as_view()),
