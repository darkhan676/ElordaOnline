...
class TeacherSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'full_name', 'email', 'password', 'qualification', 'mobile_no',
                  'skills', 'profile_img', 'teacher_courses', 'skill_list', 'total_teacher_courses']
...
class TeacherDashboardSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['total_teacher_courses',
                  'total_teacher_chapters', 'total_teacher_students']
...
class StudentSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'full_name', 'email', 'password',
                  'username', 'interested_categories', 'profile_img']
...
class StudentDashboardSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['enrolled_courses', 'favorite_courses',
                  'conmplete_assignments', 'pending_assignments']
